        ...
        content: `
          <div style="padding: 8px; max-width: 250px; font-family: Arial, sans-serif;">
            ...
            <p style="margin: 4px 0; color: #6b7280; font-size: 12px;"><strong>Status:</strong> 
              <span style="color: ${markerData.compliance === 'compliant' ? '#10b981' :
      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-4">
            {complianceFilter && (
              <Typography as="span" variant="small" className="tpx-3 py-1 bg-blue-100 text-blue-800 rounded-ful">
          ...
          <div className="w-96 bg-white border-l border-gray-200 overflow-y-auto">
            ...
            <div className="p-4 space-y-6">
              ...
              {selectedBusiness.businessInfo && (
                <div>
                  <Typography as="h3" variant="large" weight="semibold" className="flex items-center gap-2 text-md font-semibold text-gray-800 mb-3">
                    <Building size={16} />
                    Business Information
                  </Typography>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <Typography as="span" weight="medium" className="text-gray-600">
                        {selectedBusiness.businessInfo.businessid_}
                      </Typography>
                      ...
                      <Typography as="span" weight="medium" className="text-gray-600">
                        {selectedBusiness.businessInfo.ismain_ ? 'Yes' : 'No'}
                      </Typography>
                      ...
                      <Typography as="span" weight="medium" className="text-gray-600">
                        {selectedBusiness.businessInfo.isforeign_ ? 'Yes' : 'No'}
                      </Typography>
                      ...
                      <Typography as="span" weight="medium" className="text-gray-600">
                        {selectedBusiness.businessInfo.dateestablished_}
                      </Typography>
                      ...
                      <Typography as="span" weight="medium" className="text-gray-600">
                        {selectedBusiness.businessInfo.ownershiptype_}
                      </Typography>
                      ...
                      <Typography as="span" weight="medium" className="text-gray-600">
                        {selectedBusiness.businessInfo.tradename_}
                      </Typography>
              ...
              {selectedBusiness.address && (
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <Typography as="div">
                      <strong>Address:</strong> {selectedBusiness.address.houseno_}{" "}
                      {selectedBusiness.address.street_}, {selectedBusiness.address.barangay_}
                    </Typography>
                    ...
                    <Typography as="div">
                      <strong>Coordinates:</strong> {selectedBusiness.address.longlat_}
                    </Typography>

                    {selectedBusiness.address.telno_ && (
                      <Typography as="div">
                        <strong>Telephone:</strong> {selectedBusiness.address.telno_}
                      </Typography>
                    )}
              ...
              {selectedBusiness.representative && (
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <Typography as="div">
                      <strong>Ownership Type:</strong> {selectedBusiness.representative.ownershiptype_}
                    </Typography>
