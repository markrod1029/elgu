    ...
    <section className="bg-white shadow-xl rounded-2xl p-8 border border-gray-100">
      ...
      <div className="space-y-8">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <SummaryItem label="Trade Name" value={formData.tradeName} />
              <SummaryItem label="Registration Number" value={formData.registrationNumber} />
            </div>
            <div className="space-y-3">
              <SummaryItem label="Tax Identification Number" value={formData.tin} />
              <SummaryItem label="CEO/Manager Name" value={formData.ceoName} />
              <SummaryItem label="Date Enabled" value={formData.dateEnabled} type="date" />
              <SummaryItem label="T20/2025 Reference" value={formData.t202025} />
            </div>
          </div>
        </SummarySection>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              <SummaryItem label="Business Area" value={formData.businessArea} />
              <SummaryItem label="Number of Employees" value={formData.numEmployees} />
              <SummaryItem label="Commercial Building" value={formData.commercialBuilding} type="boolean" />
              <SummaryItem label="Franchise Brand" value={formData.franchiseBrand} type="boolean" />
            </div>
            <div className="space-y-3">
              <SummaryItem label="Market Stall Name" value={formData.marketStallName} />
              <SummaryItem label="Building Name" value={formData.buildingName} />
              <SummaryItem label="Unfebrafized Building" value={formData.unfebrafizedBuilding} type="boolean" />
            </div>
          </div>
        </SummarySection>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <SummaryItem label="City/Municipality" value={formData.city} />
              <SummaryItem label="Subdivision" value={formData.subdivision} />
            </div>
            <div className="space-y-3">
              <SummaryItem label="Site Area" value={formData.siteArea} />
              <SummaryItem label="Landmark" value={formData.landmark} />
              <SummaryItem label="Building Name" value={formData.addressBuildingName} />
            </div>
          </div>
        </SummarySection>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <h4 className="font-semibold text-gray-800 mb-3">SEC Registration</h4>
              <SummaryItem label="Registration No." value={formData.secRegistrationNo} />
              <SummaryItem label="Issued Date" value={formData.secRegistrationNoIssuedDate} type="date" />
              <SummaryItem label="Expiration Date" value={formData.secRegistrationNoExpirationDate} type="date" />
            </div>
            <div className="space-y-4">
              ...
              <SummaryItem label="Place of Issue" value={formData.communityTaxPlaceOfIssue} />
              <SummaryItem label="Date Registered" value={formData.communityTaxDateRegistered} type="date" />
            </div>
          </div>
        </SummarySection>
